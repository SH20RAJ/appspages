  ...
  <div class="container"> <a class="navbar-brand d-flex align-items-center" href="#">
    ...
    <div class="collapse navbar-collapse" id="navbar4">
      <ul class="navbar-nav mr-auto pl-lg-4">
        ...
        <li class="nav-item px-lg-2"> <a class="nav-link" href="submit/"><span
              class="d-inline-block d-lg-none icon-width"><i class="far fa-user"></i></i></span>Submit</a> </li>


        <li class="nav-item px-lg-2"> <a class="nav-link" href="contact/"><span
              class="d-inline-block d-lg-none icon-width"><i class="far fa-envelope"></i></span>Contact</a> </li>
...
<a class="dropdown-item" href="log/logout.php">Logout</a>
  ...
  echo '  
  <li class="nav-item px-lg-2 dropdown d-menu">
  <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="d-inline-block d-lg-none icon-width"><i class="far fa-caret-square-down"></i></span>
  Log
  </a>
  <div class="dropdown-menu shadow-sm sm-menu" aria-labelledby="dropdown01">
  <a class="dropdown-item" href="log/join/">Join</a>
